    ...
    <div className='flex flex-row justify-between'>
        ...
        <div className='relative mt-[36px] ml-[80px] flex flex-row'>
            ...
            <div className='ml-[20px]'>
                ...
                <p className='text-[38px] font-serif font-bold w-[50%] text-[#222222]'>Joe Enrique Golioth</p>
                <p className='text-[#CA6D18] text-[30px] font-serif'>Tomohon, 24 Januari 2001</p>
            </div>
        </div>
        <div className='relative mt-[36px] mr-[80px]'>
            <div className='flex flex-row items-center mb-[10px] '>
                <img src={Mail} alt="/" className='h-[20px] mr-[10px]'/>
                <p className=' underline text-[20px]'>joegolioth2401@gmail.com</p>
            </div>
            <div className='flex flex-row items-center '>
                <img src={Telephone} alt="/" className='h-[20px] mr-[10px]'/>
                <p className=' underline text-[20px]'>+6281244407300</p>
            </div>
        </div>
    </div>
  )
